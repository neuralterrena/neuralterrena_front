  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (const particle of particles) {
        ...
        // ⚡ Bolt: Math.sqrt(u*u + v*v) is significantly faster than Math.hypot(u, v) in V8.
        // This runs for every particle every frame, so this micro-optimization is worth it here.
